function [shift, centeredImg, Initial_grid_values] = FastCenterPyramid(sp_img, pre_PSWFs, weight_vec)
% 
% The main file for the centering scheme
%
% Input 
...
initial_grid_size = min(21, size(sp_img,1)-2*L); %min(21, size(sp_img,1)-2*L);
